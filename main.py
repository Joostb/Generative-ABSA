...
def init_args():
    ...
    parser.add_argument("--output_dir", default=None, help="Custom output dir.")
...
if __name__ == '__main__':
    ...
    if args.do_eval:
        ...
        dev_dataset = ABSADataset(tokenizer, data_dir=args.dataset, data_type='dev',
                        paradigm=args.paradigm, task=args.task, max_len=args.max_seq_length)
        dev_loader = DataLoader(dev_dataset, batch_size=1, num_workers=1)
        ...
        for checkpoint in all_checkpoints:
            ...
            if 0 <= int(epoch) < 100:
                ...
                (_, dev_result) = evaluate(dev_loader, model, args.paradigm, args.task, dev_sents)
                print(dev_result)
